...
import { useNewClientController } from './useNewClientController'
...
export const ClientNew = () => {
  ...
  if (!servers?.length && !isLoadingServers) {
    return (
      <ConfirmServerModal description="Para cadastrar um novo cliente, primeiro você deve cadastrar um servidor! Deseja fazer isso agora?" />
    )
  }
