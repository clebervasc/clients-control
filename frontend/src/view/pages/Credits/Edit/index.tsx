...
import { useEditCreditController } from './useEditCreditController'

interface EditCreditProps {
  servers?: Array<Server>
}

export const EditCredit = ({ servers }: EditCreditProps) => {
  const { isEditCreditModalOpen, closeEditCreditModal } = useCredit()
  const { errors, register, control, handleSubmit, isLoading } =
    useEditCreditController()
